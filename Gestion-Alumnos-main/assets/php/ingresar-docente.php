...
$stmt = $conn->prepare("INSERT INTO `profesores`(`Nombre_profesor`, `Apellido_profesor`, `nacionalidad`, `DNI`, `Cuil`, `Edad`, `Fecha de nacimiento`, `Numero de telefono`, `Numero de celular`, `Domicilio`, `Domicilio_piso`, `Domicilio_depto`, `Localidad`, `Partido`, `Mail`, `Mail_abc`, `Titulo`, `Legajo`, `Files`, `Fecha de ingreso`, `Estado`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? ,?)");
