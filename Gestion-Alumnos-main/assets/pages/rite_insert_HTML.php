    ...
    <center>
        ...
        <form action="../php/rite_insert_METODO.php" method="post">
            ...
            <select name="materia" id="materia">
                ...
                <?php foreach ($connection->query($consulta_materia) as $option) { ?>
            ...
            <select name="profesor" id="profesor">
                ...
                <?php foreach ($connection->query($consulta_profesor) as $option) { ?>
            ...
            <select name="alumno" id="alumno">
                ...
                <?php foreach ($connection->query($consulta_alumno) as $option) { ?>
